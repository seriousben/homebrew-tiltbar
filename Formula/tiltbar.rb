...
class Tiltbar < Formula
  ...
  def install
    # Generate BuildInfo.swift for release build
    ...
    # Update Info.plist placeholder with real version (for Finder Get Info, Activity Monitor)
    inreplace "Sources/TiltBar/Resources/Info.plist", "0.0.0-dev", version.to_s
